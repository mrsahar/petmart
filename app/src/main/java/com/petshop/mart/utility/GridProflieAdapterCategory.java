...
public class GridProflieAdapterCategory extends RecyclerView.Adapter<GridProflieAdapterCategory.VHMainCategory>{

    List<PostModel> postModel;
    Context context;
    Bundle b = new Bundle();
    public GridProflieAdapterCategory() {
    }

    public GridProflieAdapterCategory(List<PostModel> postModel, Context context) {
    ...
    public VHMainCategory onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = inflater.inflate(R.layout.custom_profile_grid_layout,parent,false);
