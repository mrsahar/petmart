...
public class LastLocationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(b2 != null){
            ...
            inUserAds.put("ads_price", b2.get("txtPrice"));
            //over all ads
        ...
        imgBtnLocation.setOnClickListener(v1 -> {
            try {
                ...
                Toast.makeText(getContext(), "Unable to find your location try to add it", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(getContext(), MainActivity.class).addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP));
            }
        });
        return v;
    }
